  ...
  constructor(props) {
    ...
    this.state = {
      name: window.cs142models.exampleModel().name,
        motto: "My name is Le Thi Kim Chi. I am an UIT student",
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    };
...
`<p>My name is "{this.state.name}".</p>`
        ...
        <p className="cs142-example-output">
          ...
          <p className={'motto-update'}>Short motto: {this.state.motto}</p>
          <input name="motto" onChange={e => this.ChangeHandler(e)} className="input100" type="text"
                 placeholder="type content to change short"/>
        <h3>
